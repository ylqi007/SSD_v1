...
def _process_image(directory, name):
    ...
    :param directory: string, parent path of DIRECTORY_ANNOTATIONS and DIRECTORY_IMAGES
    ...
    # filename = directory + DIRECTORY_IMAGES + 'bicubic_' + name + '.jpg'  # directory should end up with /
    ...
    for obj in root.findall('object'):
        ...
        labels.append(int(VOC_LABELS[label][0]))    # eg. 9
...
if __name__ == '__main__':
    print(VOC_LABELS['chair'][0])
    print(type(VOC_LABELS))
    print(type(VOC_LABELS['chair']))
    print(VOC_LABELS['chair'])
    print(VOC_LABELS['chair'][1])
    label = 'chair'
